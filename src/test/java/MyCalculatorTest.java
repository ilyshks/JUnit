...
public class MyCalculatorTest {
    ...
    @ParameterizedTest
    @CsvSource({ "1,2,0.5", "18.0,15.0,1.2", "-201.28,148,-1.36", "1000.92,-1000,-1.00092" })
    ...
    @ParameterizedTest
    @CsvSource({ "1,0.000000002", "18.0,10e-9", "-201.28,0.00000000999", "1000.92,0" })
    @DisplayName("Test divide operation")
    void divideTestException(double a, double b) {
